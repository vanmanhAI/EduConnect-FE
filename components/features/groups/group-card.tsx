...
function GroupCardComponent({ group }: GroupCardProps) {
  ...
  }, [loading, joinStatus, memberCount, group.id, group.isPrivate, group.name, toast, user])
  ...
  return (
    <>
              ...
              {loading ? (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="hidden sm:inline">
                    {joinStatus === "joined" ? "Đang rời..." : "Đang tham gia..."}
                  </span>
                </div>
              ) : (
      ...
      <LoginPromptDialog
        ...
        description="Bạn cần đăng nhập để tham gia và tương tác trong các nhóm học tập."
      />
    </>
  )
}
